...
public class AddSOAPArgs implements SOAPHandler<SOAPMessageContext> {
	...
	private String putArg(SOAPMessageContext smc, String propertyValue){
		...
		try {
			...
			Name name = se.createName("ManInTheMiddle", "B", "ManInTheMiddleNS");
